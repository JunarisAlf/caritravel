...
import SnackBar from "../../components/order/snack-bar";
...
const Page = () => {
  ...
  useEffect(() => {
    ...
    axios
      .get(`${localVar.API_URL}/admin/order`, {
      ...
      <DashboardLayout>
        ...
        >
          <Container maxWidth={false}>
            <OrderListToolbar setOrders={setOrders} setSnackOpen={setSnackOpen} setSnackAtr={setSnackAtr} 
            setReFecth={setReFecth} reFetch={reFetch}
            />
            <Box sx={{ mt: 3 }}>
              <OrderListResults orders={orders} setSnackOpen={setSnackOpen} setSnackAtr={setSnackAtr} 
            setReFecth={setReFecth} reFetch={reFetch}/>
            </Box>
          </Container>
        </Box>
